...
public class ChromaticNumber4 implements GraphProperty {
    ...
    public boolean execute(Graph graph) {
        ...
        int chromaticNum = 0;
        UUID current_v;
        // Возьмем вершину, которая является текущей, обновим хроматическое число и создадим список для удаления вершин
        while (!sorted_vertices.isEmpty()) {
            ...
            colors.put(current_v, chromaticNum); //добавляем в colors (map) текущую вершину и текущее хроматич. число
            ...
            for (UUID v : sorted_vertices){
                ...
                // Если вершина не смежная и можно покрасить
